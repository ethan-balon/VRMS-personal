...
describe("VehicleModel", function() {
    ...
    it("should search vehicles by make, model, or type", function() {
      //create three test vehicles, use the searchVehicle() function to search vehicles by make, model, and type
        const v1 = { vehicleId: "V1", make: "Toyota", model: "Corolla", type: "Sedan" };
        const v2 = { vehicleId: "V2", make: "Honda", model: "Civic", type: "Sedan" };
        const v3 = { vehicleId: "V3", make: "Toyota", model: "Camry", type: "SUV" };
        vehicleModel.addVehicle(v1);
        vehicleModel.addVehicle(v2);
